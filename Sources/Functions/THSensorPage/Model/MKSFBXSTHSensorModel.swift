...
enum THSensorModelError: LocalizedError {
...
@MainActor class MKSFBXSTHSensorModel {
    ...
    private func configSamplingInterval() async throws -> Bool {
        do {
            ...
            if !result {
                throw THSensorModelError.configSamplingInterval
            }
    ...
    private func configStoreParams() async throws -> Bool {
        do {
            ...
            if !result {
                throw THSensorModelError.configStoreParams
            }
