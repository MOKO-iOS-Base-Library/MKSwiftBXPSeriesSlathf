//
//  MKSFBXSFilterHTHistoryHeaderView.swift
...
// MARK: - Protocol
protocol MKSFBXSFilterHTHistoryHeaderViewDelegate: AnyObject {
...
class MKSFBXSFilterHTHistoryHeaderView: UIView {
    
    // MARK: - Protocol
    weak var delegate: MKSFBXSFilterHTHistoryHeaderViewDelegate?
